  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--color-bg)' }}>
      ...
      <div className="h-11 flex items-center justify-between px-4 shrink-0"
        style={{ background: 'rgba(255,255,255,0.85)', backdropFilter: 'blur(10px)', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
      ...
      {/* 底部导航 */}
      <div className="flex items-center justify-around px-2 py-1.5 shrink-0"
